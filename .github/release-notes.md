A small Windows utility that accepts your `mailto:` links, asks which profile you want to send from, and opens Gmail's compose window in your default browser, in the right email account.

Teach it which profile to route your email to (ex: *anything at this domain goes from my work account*), and it will do it automatically! Without scripting, or hand-edited configuration files.
...
Then add a profile, say yes to becoming the mail handler, and you're done.
